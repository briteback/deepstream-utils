...
class RpcUtils {
    ...
    make(rpc, data = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (callStart + this.retryRPCTimeout > Date.now()) {
                try {
                    yield this.preprocessRpcData(data);
    ...
    preprocessRpcData(data) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.options.preprocessRpcData) {
                yield this.options.preprocessRpcData(data);
            }
        });
    }
    upgradeRpcData(data) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.options.upgradeRpcData) {
                yield this.options.upgradeRpcData(data);
            }
        });
    }
    /**
    ...
    provide(rpc, cb, options) {
        if (options && this.audit) {
            const self = this;
            this.client.rpc.provide(rpc, (data, response) => __awaiter(this, void 0, void 0, function* () {
                yield this.upgradeRpcData(data);
